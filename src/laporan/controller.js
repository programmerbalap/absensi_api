                ...
                SELECT
                  CASE
                    WHEN SUM(TIMESTAMPDIFF(MINUTE, a.time_start, a.time_end)) > 60 THEN
                      (
                        (FLOOR(SUM(TIMESTAMPDIFF(MINUTE, a.time_start, a.time_end)) / 60) * 2 * a.nominal_gaji) - (a.nominal_gaji * 0.5)
                      ) + 
                      (
                        ROUND(SUM(TIMESTAMPDIFF(MINUTE, a.time_start, a.time_end)) % 60 * 2 * a.nominal_gaji / 60)
                      )
                    ELSE
